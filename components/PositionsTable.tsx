...
const STATUS_BADGE: Partial<Record<string, { label: string; className: string }>> = {
...
export function PositionsTable({ positions, market, closingPositionId, closePosition }: PositionsTableProps) {
  const livePositions = useMemo(() => {
    ...
    return positions.map(pos => {
      ...
      const pnl = calcPnl(pos.size, pos.entry, currentPrice);
      return {
        ...pos,
